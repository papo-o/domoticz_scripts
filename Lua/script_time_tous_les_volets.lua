...
Date de mise à jour : 15/04/2018
...
les_volets[#les_volets+1] = {volet="Chambre Maud", Type="somfy"}
-- 6eme volet : nom du device volet 6 
les_volets[#les_volets+1] = {volet="Chambre Audrey", Type="velux"}
...
-- retourne le temps en seconde depuis la dernière maj du périphérique
